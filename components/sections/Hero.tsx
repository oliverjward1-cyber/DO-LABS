  ...
  return (
    <section className="flex flex-col items-center px-4 py-16 text-center sm:py-24">
      ...
      <a
        ...
        className="reveal mt-8 inline-flex items-center gap-2.5 rounded-pill border border-obsidian/20 px-4 py-2 text-sm text-obsidian motion-safe:transition-colors hover:border-obsidian/40"
